...
const Login = () => {
  ...
  return (
    <div>
        ...
        <form className="w-4/12 absolute p-12 bg-black mt-36 mx-auto right-0 left-0 text-white rounded-lg">
            ...
            />}
            <input className='bg-[#1f1f1f] rounded-sm p-3 my-2 text-white w-full ' 
                   type="text" 
            ...
            />
            <button className=' cursor-pointer font-bold text-l p-4 my-4 bg-[#e50914] rounded-sm w-full'>
                {isSignInForm ? "Sign In" : "Sign Up"}
            </button>
